...
for (const file of liveFiles) {
  ...
  const allowedGenerated = rel.startsWith('/admin/') || rel.startsWith('/hubs/') || rel.startsWith('/reference/') || rel.startsWith('/coverage/') || rel.startsWith('/insights/') || rel.startsWith('/articles/') || rel.startsWith('/whitepapers/') || rel.startsWith('/authority/') || rel === '/faq/' || rel === '/scenario/' || rel === '/compare/' || rel === '/state/';
