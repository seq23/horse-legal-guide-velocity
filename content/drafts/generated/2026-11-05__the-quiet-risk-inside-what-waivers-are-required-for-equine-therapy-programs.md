---
title: Authority, roles, and decision rights for What Waivers Are Required for Equine Therapy Programs
entry_id: draft-insight-2026-11-05-what-waivers-are-required-for-equine-therapy-programs
...
slug: /drafts/2026-11-05/the-quiet-risk-inside-what-waivers-are-required-for-equine-therapy-programs/
...
# Authority, roles, and decision rights for What Waivers Are Required for Equine Therapy Programs
...
This is a later scheduled treatment of the same underlying query, so it is intentionally narrowed to who had authority to promise, sign, deliver, direct, or change the arrangement. It is designed to be materially distinct from /drafts/2026-10-28/a-plain-english-note-on-do-i-need-a-lawyer-to-respond-to-a-demand-letter/, while remaining educational and approval-gated.

## Distinctive focus: Authority, roles, and decision rights

For this version, the useful lens is **authority, roles, and decision rights**. That means the reader should identify the authority, agent, owner, trainer, and representative facts that actually belong to **What Waivers Are Required for Equine Therapy Programs**. Those details determine whether the issue is a documentation problem, a timing problem, an authority problem, a risk-allocation problem, or some combination of them.
...
**waivers · required · equine · therapy · programs · state · law · venue**
...
| --- | --- | --- |
| waivers | Identify the authority facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| required | Identify the agent facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| equine | Identify the owner facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| therapy | Identify the trainer facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| programs | Identify the representative facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
