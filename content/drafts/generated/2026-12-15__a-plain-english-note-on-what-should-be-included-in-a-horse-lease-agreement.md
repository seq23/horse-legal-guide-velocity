...
| document | Identify the warning language facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
