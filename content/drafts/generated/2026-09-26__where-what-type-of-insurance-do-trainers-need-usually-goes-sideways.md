---
title: State-law, venue, and local-rule lens for What Type of Insurance Do Trainers Need
...
# State-law, venue, and local-rule lens for What Type of Insurance Do Trainers Need
...
**type · insurance · trainers · need · state · law · venue · local**
...
| --- | --- | --- |
| type | Identify the jurisdiction facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| insurance | Identify the venue facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| trainers | Identify the choice of law facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| need | Identify the statute facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
