...
This draft is intentionally scoped to how to preserve options, reduce avoidable escalation, and prepare the record for early resolution. It is designed to be materially distinct from /drafts/2026-09-01/white-paper-horse-lease-trial-risk-allocation-documentation-and-plain-english-guardrails/, while remaining educational and approval-gated.
