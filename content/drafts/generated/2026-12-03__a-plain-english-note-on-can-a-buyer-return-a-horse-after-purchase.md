---
title: Operational handoff and responsibility map for Can a Buyer Return a Horse After Purchase
...
# Operational handoff and responsibility map for Can a Buyer Return a Horse After Purchase
...
**buyer · return · horse · purchase · operational · handoff · responsibility · map**
...
| --- | --- | --- |
| buyer | Identify the care facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| return | Identify the maintenance facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
...
| purchase | Identify the boarding facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
