...
This draft is intentionally scoped to how injury, coverage, waiver language, and responsibility allocation affect risk. It is designed to be materially distinct from /drafts/2026-05-22/how-to-think-about-lease-vs-purchase-horse-before-you-act/, while remaining educational and approval-gated.
...
**happens · boarder · damages · property · think · act · boarding · training**
...
| think | Identify the coverage facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
...
| --- | --- | --- |
| Parties and authority | Names, roles, ownership, agency, and signature authority tied to What Happens If a Boarder Damages Property | Prevents the wrong person or entity from being treated as bound. |
