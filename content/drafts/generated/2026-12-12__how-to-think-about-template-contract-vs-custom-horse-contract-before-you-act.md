---
title: Evidence and timeline audit for Template Contract vs Custom Horse Contract
entry_id: draft-insight-2026-12-12-template-contract-vs-custom-horse-contract
...
slug: /drafts/2026-12-12/how-to-think-about-template-contract-vs-custom-horse-contract-before-you-act/
review_status: pending
github_path: content/drafts/generated/2026-12-12__how-to-think-about-template-contract-vs-custom-horse-contract-before-you-act.md
uniqueness_status: passed
uniqueness_strategy: evidence-timeline
---
<!-- UNIQUE_SELF_HEAL_START -->
# Evidence and timeline audit for Template Contract vs Custom Horse Contract
...
This is a later scheduled treatment of the same underlying query, so it is intentionally narrowed to how the chronology, records, and sequence of events change the practical risk. It is designed to be materially distinct from /drafts/2026-10-19/how-to-think-about-trademark-vs-llc-name-for-a-horse-business-before-you-act/, while remaining educational and approval-gated.

## Distinctive focus: Evidence and timeline audit

For this version, the useful lens is **evidence and timeline audit**. That means the reader should identify the chronology, sequence, timestamp, handoff, and notice facts that actually belong to **Template Contract vs Custom Horse Contract**. Those details determine whether the issue is a documentation problem, a timing problem, an authority problem, a risk-allocation problem, or some combination of them.
...
**template · contract · custom · horse · authority · roles · decision · rights**
...
| --- | --- | --- |
| template | Identify the chronology facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
...
| custom | Identify the timestamp facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
...
| authority | Identify the notice facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
