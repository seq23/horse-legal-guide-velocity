---
title: A Plain-English Note on Stable rules document vs boarding contract
entry_id: continuity-insight-2027-01-05-stable-rules-document-vs-boarding-contract
...
slug: /drafts/2027-01-05/a-plain-english-note-on-stable-rules-document-vs-boarding-contract/
review_status: pending
github_path: content/drafts/generated/2027-01-05__a-plain-english-note-on-stable-rules-document-vs-boarding-contract.md
uniqueness_status: passed
uniqueness_strategy: operations-handoff
---
<!-- UNIQUE_SELF_HEAL_START -->
# A Plain-English Note on Stable rules document vs boarding contract
...
This draft is intentionally scoped to how day-to-day responsibilities are handed off and documented in the horse-world operation. It is designed to be materially distinct from /drafts/2027-01-05/contract-vs-handshake-deal-in-a-horse-sale-a-practical-guide-to-the-questions-that-usually/, while remaining educational and approval-gated.
...
| stable | Identify the transport facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| rules | Identify the boarding facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
| document | Identify the training facts tied specifically to this question. | Keep the source, date, person, and document connected so the record is usable. |
