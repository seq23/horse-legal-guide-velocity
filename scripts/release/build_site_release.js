...
<section id="login-landing" class="login-grid">
  <div class="card warn password-card">
    <p class="eyebrow">Client/admin reference</p>
    <h2>Admin password</h2>
    <p class="password-display"><code>${escapeHtml(password)}</code></p>
